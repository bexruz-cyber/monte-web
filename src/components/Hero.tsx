            ...
            <div className="max-w-[1420px] mx-auto px-5 flex max-md:px-0 max-lg:flex-col items-center gap-10  h-full">
                ...
                <div className="pl-[30px] max-lg:pl-0 w-full max-md:px-5 max-w-[640px] h-full py-7 max-lg:h-screen flex flex-col">
                    <div className="flex items-center">
                        <img src={site_logo} alt="Site logo" className="max-w-[128px] w-full" />
                    ...
                    <div className="my-auto">
                        <p className="font-normal font_400 text-lg text-black text-center mb-3">Building Your Dreams</p>
                        <h1 className="font-normal font_400 text-[56px] max-md:text-5xl max-md:max-w-[433px] max-sm:text-4xl max-[375px]:text-3xl mx-auto text-center max-w-[581px]">
                            Real Estate in Dubai: Ideal for Living and Investing
                        </h1>
                    </div>
                    <div className="flex justify-between items-center">
                        <button className="bg-[#141414] rounded-[80px] max-md:mx-auto p-1 flex items-center gap-2.5 font-normal text-lg text-white pr-5">
                        ...
                        <div className="flex items-center gap-4 max-md:hidden">
                            <p className="font-normal font_400 text-sm text-black max-w-[89px]">Explore All Our Properties</p>
                ...
                {/* right */}
                <div className="w-full max-w-[710px] h-full flex flex-col max-lg:h-screen p-[30px] relative rounded-4xl overflow-hidden">
                    <div className="flex items-center relative z-20 mb-auto">
                        <p className="mr-[57px] max-w-[179px] font-medium font_500 max-md:hidden text-white text-lg leading-5">More than 1500 real estate properties</p>
                        <p className="mr-auto max-w-[179px] font-medium font_500 max-md:hidden text-white text-lg leading-5">From $145,000 with a yield of 10% per annum</p>
                        <div className="flex items-center max-md:ml-auto gap-2">
                    ...
                    <img src={heroRight} alt="Dubai" className="absolute w-full h-full top-0 left-0 object-cover object-center" />
                    <div className="flex items-center justify-between relative z-20">
                        <p className="mr-[57px] max-w-[179px] font-medium font_500 md:hidden  text-white text-lg leading-5">More than 1500 real estate properties</p>
                        <button className=" bg-white rounded-[20px] max-md:min-w-[145px] px-5 py-4 max-w-[167px] max-md:textsm max-md:py-2.5 max-md:px-4 max-md:rounded-[10px] ml-auto flex items-center gap-5 text-left font-normal font_400 text-base leading-5">
                            catalog download
